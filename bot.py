...
async def pdisk_up(link):
    if ('pdisk' in link or 'kuklink' in link or 'kofilink' in link or 'cofilink' in link or 'bit' in link or 'vdshort' in link or 'Pdisklink' in link or 'Pdisks' in link or 'droppx' in link or 'dplinks' in link or 'www.dropxer.net' in link or 'www.pdisk' in link or 'www.pdisks' in link or 'wslinker' in link or 'cdinks' in link):
